...
- 12 счетов
- 39 транзакций
- часть операций ошибочные
- часть операций suspicious / high-risk
- очередь, история клиента, suspicious operations, top-3 клиентов
...
- создание банка, 6 клиентов и 12 счетов;
- стартовые пополнения, проценты и инвестиции;
- 39 транзакций с `completed`, `failed`, `canceled` и delayed-сценариями;
- queue preview: попадание в очередь, отмену и результаты обработки;
- счета выбранного клиента;
- историю транзакций выбранного клиента;
- suspicious operations выбранного клиента;
- top-3 клиентов по суммарному балансу;
- статистику транзакций;
- общий баланс банка в базовой валюте.
